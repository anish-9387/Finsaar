...
import { ChevronDown, ChevronUp, Search, MoreHorizontal, TrendingUp, Trash2, BarChart2, Briefcase, Activity } from 'lucide-react';
...
const WatchList = () => {
  ...
  return (
    <div className="w-full md:w-100 h-full flex flex-col border-r border-gray-200 bg-white">
      {/* Search */}
