    ...
    <footer className="border-top" style={{backgroundColor: "rgb(250,250,250)"}}>
      <div className="container mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            <p>Company</p>
            <a href="w" style={{textDecoration: "none", color: "black"}}>About</a><br />
            <a href="w" style={{textDecoration: "none", color: "black"}}>Products</a><br />
            <a href="w" style={{textDecoration: "none", color: "black"}}>Pricing</a><br />
            <a href="w" style={{textDecoration: "none", color: "black"}}>Referral programme</a><br />
            <a href="w" style={{textDecoration: "none", color: "black"}}>Careers</a><br />
            <a href="w" style={{textDecoration: "none", color: "black"}}>Zerodha.tech</a><br />
            <a href="w" style={{textDecoration: "none", color: "black"}}>Press & media</a><br />
            <a href="w" style={{textDecoration: "none", color: "black"}}>Zerodha cares (CSR)</a><br />
          </div>

          <div className="col">
            <p>Support</p>
            <a href="w"style={{textDecoration: "none", color: "black"}}>Contact</a><br />
            <a href="w"style={{textDecoration: "none", color: "black"}}>Support portal</a><br />
            <a href="w"style={{textDecoration: "none", color: "black"}}>Z-Connect blog</a><br />
            <a href="w"style={{textDecoration: "none", color: "black"}}>List of charges</a><br />
            <a href="w"style={{textDecoration: "none", color: "black"}}>Downloads & resources</a><br />
          </div>

          <div className="col">
            <p>Account</p>
            <a href="w"style={{textDecoration: "none", color: "black"}}>Open an account</a><br />
            <a href="w"style={{textDecoration: "none", color: "black"}}>Fund transfer</a><br />
            <a href="w"style={{textDecoration: "none", color: "black"}}>60 day challenge</a><br />
          </div>
        </div>
