...
function Universe() {
  return (
    <div className="container mt-5 universe">
      <div className="row text-center universe-logos">
        <h1>The Zerodha Universe</h1>
        <p>Extend your trading and investment experience even further with our partner platforms</p>

        <div className="col-4 p-3 mt-5 universe-item">
          <img className="universe-logo" src="media/images/zerodhaFundhouse.png" alt="Zerodha Fund House" />
        ...
        <div className="col-4 p-3 mt-5 universe-item">
          <img className="universe-logo" src="media/images/sensibullLogo.svg" alt="Sensibull" />
        ...
        <div className="col-4 p-3 mt-5 universe-item">
          <img className="universe-logo" src="media/images/tijori.svg" alt="Tijori" />
        ...
        <div className="col-4 p-3 mt-5 universe-item">
          <img className="universe-logo" src="media/images/streakLogo.png" alt="Streak" />
        ...
        <div className="col-4 p-3 mt-5 universe-item">
          <img className="universe-logo" src="media/images/smallcaseLogo.png" alt="Small Case" />
        ...
        <div className="col-4 p-3 mt-5 universe-item">
          <img className="universe-logo" src="media/images/dittoLogo.png" alt="Ditto" />
