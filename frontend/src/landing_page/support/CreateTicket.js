    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>Account modification and segmentation</a><br />
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4><i class="fa fa-plane" aria-hidden="true"></i> Trading and Markets</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4><i class="fa fa-money" aria-hidden="true"></i> Funds</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4><i class="fa fa-cogs" aria-hidden="true"></i> Console</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4><i class="fa fa-inr" aria-hidden="true"></i> Coin</h4>
