    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8 border-b border-gray-100 pb-4">
        ...
        <div className="flex gap-4">
          <button className="flex items-center gap-2 bg-[#4caf50] text-white px-4 py-2 rounded text-sm font-medium hover:bg-[#43a047] transition-colors">
            <Plus className="h-4 w-4" /> Add funds
          </button>
          <button className="flex items-center gap-2 bg-[#444] text-white px-4 py-2 rounded text-sm font-medium hover:bg-[#333] transition-colors">
        ...
        <div>
          ...
          <div className="border border-gray-100 bg-white rounded-sm">
            <div className="flex justify-between p-3 md:p-4 border-b border-gray-100 items-center">
              ...
              <span className="text-xl md:text-2xl text-[#387ed1] font-medium">4,043.10</span>
            </div>
            <div className="flex justify-between p-3 md:p-4 border-b border-gray-100 items-center bg-gray-50">
              ...
              <span className="text-base md:text-lg text-[#444] font-medium">3,757.30</span>
            </div>
            <div className="flex justify-between p-3 md:p-4 border-b border-gray-100 items-center bg-gray-50">
              <span className="text-xs md:text-sm text-[#444]">Available cash</span>
              <span className="text-base md:text-lg text-[#444] font-medium">4,043.10</span>
            </div>
